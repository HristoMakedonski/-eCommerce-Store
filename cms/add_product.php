                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="portlet_tab1">
                                        ...
                                        if(isset($_POST['submit'])){
                                            ...
                                            $pro_id = uniqid();
                                            $query = "insert into products(product_cat,product_id,product_name,product_desc,product_img,product_price) values ('$pro_cat','$pro_id','$pro_name','$pro_desc','$pro_img','$pro_price')";
