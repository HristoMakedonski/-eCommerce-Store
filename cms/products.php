...
<div class="page-container row-fluid">
    ...
    if($run === true){
        echo "Product has been delete successfully";
    }else{
    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <!-- END PAGE HEADER-->
            <a href="add_product.php" class="btn btn-success" >Add Product</a><h2></h2>
            <!-- BEGIN PAGE CONTENT-->
            <div class="row-fluid">
                <div class="span12">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="response">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="update_project.php?id=<?php echo $row['product_id'];?>">Update |</a>
